...
FX::FXCheckBox::FXCheckBox()
{
}
FX::FXCheckBox::FXCheckBox(const char* check_box_caption, FX::FXRect check_box_r, FX::FXDisplay* display)
    :
    d(display),
    rect(check_box_r),
...
void
FX::FXCheckBox::Selected(bool _selected)
{
    selected = _selected;
}
